(function () {
  ...
  // A Conferência de Postagem e a Conferência ProjectWise são módulos
  // independentes e carregados sob demanda. Só os pequenos bootstraps entram
  // na inicialização; XLSX, ExcelJS, relatórios e UIs continuam fora do caminho
  // crítico até o operador abrir a respectiva área.
  function installPostingConferenceBootstrap() {
    const scripts = [
      ...
      ["projectwise_bootstrap.js", "grconProjectWiseBootstrap"],
    ];
