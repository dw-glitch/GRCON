...
Gerar uma eGRDT não abre nem prepara a resposta automaticamente. Essa opção fica exclusivamente no Histórico, para o operador decidir quando montar a mensagem.
