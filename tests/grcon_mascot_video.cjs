...
assert.match(controller, /video-transparency-warning/);
assert.doesNotMatch(controller, /useFallback\("opaque-video-background"\)/, "probe visual não pode bloquear preventivamente um WebM aprovado");
