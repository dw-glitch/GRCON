(function (root, factory) {
  const api = factory(root.GrconDatabookSupport || (typeof module === "object" && module.exports ? require("./grdt_databook_support.js") : null));
  if (typeof module === "object" && module.exports) module.exports = api;
  root.GrconTitleQuality = api;
})(typeof globalThis !== "undefined" ? globalThis : this, function (S) {
  "use strict";

  function text(value) { return value === null || value === undefined ? "" : String(value).trim(); }
  function norm(value) { return S && S.norm ? S.norm(value) : text(value).normalize("NFD").replace(/[\u0300-\u036f]/g, "").toUpperCase().replace(/\s+/g, " "); }
  function key(value) { return S && S.key ? S.key(value) : norm(value).replace(/\s*([_.-])\s*/g, "$1"); }
  function titleKind(value) { return S && S.titleKind ? S.titleKind(value) : ""; }
