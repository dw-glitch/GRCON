...
(async () => {
  ...
  try {
    ...
    await page.waitForFunction(() => document.querySelector("#spw-evo-detail-body")?.textContent?.includes("Código"));
    ...
    const evolutionDetailText = await page.locator("#spw-evo-detail-body").textContent();
