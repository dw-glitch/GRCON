(function (root, factory) {
  ...
  function reviewResult(input, values) {
    ...
    const result = {
      ...
      revision: normalizeRevision(item.revision),
      revisionSuggested: item.revisionSuggested !== undefined ? item.revisionSuggested : normalizeRevision(item.revision),
  ...
  function simpleReason(row) {
    ...
    const exactStatuses = {
      ...
      "COMPOSICAO N-1710 INCOMPLETA": "Para N-1710, inclua o par físico do mesmo código. LI e MC exigem 1 Excel + 1 PDF; os demais tipos exigem 1 arquivo nativo + 1 PDF. Os dois serão gravados na eGRDT com o mesmo número e revisão.",
