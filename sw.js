...
const CACHE_NAME = "grcon-v5.41.0-mascot-pilot1-egrdt-teams-notification1-phase-a-history-react1-phase-b-consultas-ui1-hardening1-phase-b-history-ui1-history-perf-hardening1-phase-a-pdf-tools-react1-phase-b-pdf-tools-ui1-phase-a-egrdt-history-react1-phase-b-egrdt-history-ui1-phase-a-sigem-pw-react1-phase-b-sigem-pw-ui1-ui2-deploy-history-mascot-overlap2-phase-a-sigem-pw-revision-react1-phase-b-sigem-pw-revision-ui1-cover-document2-hardening1";
const ASSETS = [
  "index.html",
  "design-system.css",
  "legacy-compat.css",
...
const HEAVY_ASSETS = new Set([
  ...
  "supabase.min.js",
  "grdt-template.xlsx",
  "CAPA_PAGE1_BASE.pdf.b64.001",
  "CAPA_PAGE1_BASE.pdf.b64.002",
  "CAPA_PAGE1_BASE.pdf.b64.003",
  "CAPA_PAGE1_BASE.pdf.b64.004",
  "CAPA_PAGE1_BASE.pdf.b64.005",
  "CAPA_PAGE1_TEMPLATE.docx.b64.001",
  "CAPA_PAGE1_TEMPLATE.docx.b64.002",
  "grcon-icon.png",
  "grcon-icon.ico",
  "grcon-logo-app.png",
  "grcon-logo-app.ico",
